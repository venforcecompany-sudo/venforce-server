...
function promptSeo(anuncio) {
  return [
    "Tarefa: gerar sugestão de título para Mercado Livre e campo modelo.",
    "",
    "Regras do título Mercado Livre:",
    "- Máximo de 60 caracteres (limite rígido).",
    "- Claro, descritivo e otimizado para busca.",
    "- Priorizar palavras-chave relevantes.",
    ...
    "",
    "Campo modelo:",
    "- Palavras indexadoras curtas, diretamente relacionadas ao produto.",
    "- Devem complementar o título, sem repeti-lo inteiro.",
    "- Termos úteis para busca no Mercado Livre.",
    "- Não usar palavras sem relação com o produto.",
    "",

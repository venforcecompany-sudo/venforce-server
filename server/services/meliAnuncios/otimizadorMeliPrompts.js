...
function promptSeo(anuncio) {
  return [
    ...
    "- O campo modelo é um bloco puro de palavras-chave indexadoras, separadas APENAS por espaço.",
    "- NÃO é frase, NÃO é descrição, NÃO é comercial.",
    "- NÃO deve repetir palavras do titulo_sugerido.",
    "- NÃO use conectivos: de, para, com, e, em, do, da, dos, das.",
    "- NÃO invente marca, medida, material, compatibilidade ou benefício.",
    "- NÃO repita nenhuma palavra dentro do próprio modelo.",
    "- Prefira sinônimos, variações de busca, termos técnicos, aplicações e nomes alternativos do produto.",
    "- Faixa obrigatória: mínimo 49 e máximo 50 caracteres. Se o último termo estourar levemente, pode ultrapassar.",
    "- Se não houver dados suficientes para atingir 49 chars sem inventar, use os termos seguros disponíveis.",
    "- Exemplo bom (produto: Barra Reta Aço 1,50m Academia):",
    '  Modelo: "olimpico academia musculacao anilha halter head"',
    "- Exemplo ruim:",
    '  Modelo: "barra reta aço cromado 1,50m par presilha academia ginastica"',
    "",
    "",
    "Score SEO (0 a 100):",

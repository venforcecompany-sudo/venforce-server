...
"- Gere 3 opções de título para Mercado Livre.",
"- Cada título deve ter no máximo 60 caracteres.",
"- Tente usar entre 55 e 60 caracteres sempre que possível.",
"- Se não houver informação real suficiente para chegar em 55 caracteres, gere o melhor título possível sem inventar.",
"- Nunca corte palavra pela metade.",
"- As 3 opções devem ser diferentes entre si.",
"- Não inventar marca, material, medida, compatibilidade ou benefício.",
"- Marca só pode ser usada se estiver confirmada nos dados do anúncio.",
"- Priorize tipo do produto, medida, quantidade, material, uso principal, característica relevante e marca confirmada.",
"- Linguagem clara, descritiva e otimizada para busca no Mercado Livre.",
"- Evitar repetições desnecessárias e caixa alta forçada.",
"- Não usar emojis nem símbolos desnecessários.",
"- Se algum título ficar abaixo de 55 caracteres, explique no motivo por que faltou informação real para completar.",
"- titulo_sugerido deve ser a melhor opção recomendada pela IA.",
"- titulos_alternativos deve conter as 3 opções para o gestor escolher.",
    "",
    "Campo modelo:",
